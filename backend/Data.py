...
class Dataset:
    ...
    def load_np(self, type, bars):
        self.np_type = type
        self.np_bars = bars
        arglist = [[df.df, type, bars] for df in self.dfs]
 ...
 #   return []
    ...
    def __init__(self, request=None, bars=0, offset=0, value=None, pm=True, np_bars=50):
        from Screener import Screener as screener
        if request == None:
        ...
        self.dfs = Main.pool(Dataset.init_worker, arglist)
